...
export PATH="/usr/local/sbin:/usr/local/bin:/usr/bin:$HOME/.local/bin:$HOME/bin:$HOME/dotfiles/bash:$BUN_INSTALL/bin:$HOME/go/bin:$HOME/.emacs.d/bin:$HOME/.cargo/bin"
